...
class xi_2pt(object):
  ...
  def xi_2pt(cata,catb=None,k=None,ga=None,gb=None,corr='GG',maska=None,maskb=None,wa=None,wb=None,ran=True,mock=False,erron=True,jkmask=None,label0='',plot=False,conj=False,bin1=0,bin2=0,rtype=1):
    ...
    def mcal_norm_2(cata,catxa,catRga,w,maska):
      ...
      print 'RS1,RS2',RS1**2,RS2**2,(RS1-np.mean(RS10))/np.sqrt(RS1p.varxi),(RS2-np.mean(RS20))/np.sqrt(RS1p.varxi)
    ...
    def mcal_norm_3(cata,catxa,catRga,w,maska):
      ...
      RS1=(RS1p.xi-RS1m.xi)/(2.*config.cfg.get('mcal_dg'))
      RS2=(RS2p.xi-RS2m.xi)/(2.*config.cfg.get('mcal_dg'))
      print 'RS1,RS2',RS1,RS2,(RS1-np.mean(RS10))/np.sqrt(Rg.varxi),(RS2-np.mean(RS20))/np.sqrt(Rg.varxi)
